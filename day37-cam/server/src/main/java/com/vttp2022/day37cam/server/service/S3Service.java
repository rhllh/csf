package com.vttp2022.day37cam.server.service;
...
public class S3Service {
    ...
    public String upload(MultipartFile file, String title, String comment) throws IOException {
